angular.module('App.services', ['ngResource']).service('restService', [
    '$http', '$log',
    function ($http, $log) {
        var dataUri = 'api/v1/data/', //'api/v1/data/',
    ...
    return {
        ...
        getProductWithParams: function(id, onSuccess, onFail) {
            $http.get(
                dataUri + "productwithparams.json",
                {
                    //params: {
                    //    id: id
                    //}
        ...
        getTopProductsByTimeAndType: function(time, type, onSuccess, onFail) {
            $http.get(dataUri + "topproducts.json", {
                //params: {
                //    time: time,
                //    type: type
                //}
