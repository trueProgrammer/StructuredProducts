...
CREATE TABLE INSTRUMENT.EMAIL (
  id SERIAL PRIMARY KEY,
  email TEXT NOT NULL,
  brokerId INTEGER REFERENCES INSTRUMENT.BROKER(id) NOT NULL
);

CREATE TABLE INSTRUMENT.SYSTEM_PROPERTY (
  key TEXT PRIMARY KEY,
  value TEXT
);

INSERT INTO INSTRUMENT.SYSTEM_PROPERTY VALUES ('service_mail', 'xstrum.service@gmail.com');

ALTER TABLE INSTRUMENT.PRODUCT_PARAMS ADD COLUMN showChart boolean;
ALTER TABLE INSTRUMENT.PRODUCT_TYPE ADD COLUMN riskType TEXT;
ALTER TABLE INSTRUMENT.UNDERLAYING ADD COLUMN period TEXT;
ALTER TABLE INSTRUMENT.PRODUCT RENAME COLUMN currency to input_currency;
ALTER TABLE INSTRUMENT.PRODUCT ADD COLUMN output_currency INTEGER REFERENCES INSTRUMENT.CURRENCY;
